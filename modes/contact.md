...
4. **Generate message** with the 3-sentence framework adapted to contact type:

   ### Recruiter
   - **Sentence 1 (Fit)**: Direct match criteria -- role, relevant experience, availability or location
   - **Sentence 2 (Proof)**: A data point that answers their screening questions before they ask them (e.g., "5 years building ML pipelines, currently in Amsterdam, available immediately")
...
5. **Versions**:
   - EN (default)
   - Local language (if company is in a non-English market)
