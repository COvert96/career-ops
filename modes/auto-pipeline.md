...
Execute exactly as the `offer` mode (read `modes/offer.md` for all blocks A-F + Block G Posting Legitimacy).
...
- **Direct, no fluff**: 2-4 sentences per response. No "I'm passionate about..." or "I would love the opportunity to..."
